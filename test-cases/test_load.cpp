...
TEST_F(LoadTest, LD_register_indirect_register_test){
    constexpr std::array<uint8_t, 22> expected_reg_values = {
            0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x00, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03, 0x04,
            0x04, 0x05, 0x05, 0x06, 0x06, 0x07
    };
    constexpr std::array<uint8_t, 30> memory = {
            0x3E, 0x01, 0x06, 0x02, 0x0E, 0x03, 0x16, 0x04,
            0x1E, 0x05, 0x26, 0x06, 0x2E, 0x07, 0x77, 0x3E,
            0x00, 0x7E, 0x70, 0x7E, 0x71, 0x7E, 0x72, 0x7E,
            0x73, 0x7E, 0x74, 0x7E, 0x75, 0x7E
    };
...
TEST_F(LoadTest, LD_register_indirect_register_BC_test){
    constexpr std::array<uint8_t, 6> expected_reg_values = {0x00, 0x00, 0xFF, 0xFF, 0x00, 0xFF};
    constexpr std::array<uint8_t, 10> memory =
            {0x06, 0x02, 0x0E, 0x03, 0x3E, 0xFF, 0x02, 0x3E, 0x00, 0x0A};
...
TEST_F(LoadTest, LD_register_indirect_register_DE_test){
    constexpr std::array<uint8_t, 6> expected_reg_values = {0x00, 0x00, 0xFF, 0xFF, 0x00, 0xFF};
    constexpr std::array<uint8_t, 10> memory =
            {0x16, 0x02, 0x1E, 0x03, 0x3E, 0xFF, 0x12, 0x3E, 0x00, 0x1A};
...
TEST_F(LoadTest, LD_indexed_ix_immediate_test){
    constexpr std::array<uint8_t, 3> expected_reg_values = {0x00, 0x00, 0xFF};
    constexpr std::array<uint8_t, 11> memory =
            {0xDD, 0x21, 0x00, 0x01, 0xDD, 0x36, 0x80, 0xFF, 0xDD, 0x7E, 0x80};
...
TEST_F(LoadTest, LD_indexed_iy_immediate_test){
    constexpr std::array<uint8_t, 3> expected_reg_values = {0x00, 0x00, 0xFF};
    constexpr std::array<uint8_t, 11> memory =
            {0xFD, 0x21, 0x00, 0x01, 0xFD, 0x36, 0x80, 0xFF, 0xFD, 0x7E, 0x80};
...
TEST_F(LoadTest, LD_indexed_ix_register_test){
    constexpr std::array<uint8_t, 23> expected_reg_values = {
            0x00, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01,
            0x01, 0x00, 0x01, 0x01, 0x02, 0x02, 0x03, 0x03,
            0x04, 0x04, 0x05, 0x05, 0x06, 0x06, 0x07
    };
    constexpr std::array<uint8_t, 62> memory = {
            0xDD, 0x21, 0x00, 0x01, 0x3E, 0x01, 0x06, 0x02,
            0x0E, 0x03, 0x16, 0x04, 0x1E, 0x05, 0x26, 0x06,
            0x2E, 0x07, 0xDD, 0x77, 0x80, 0x3E, 0x00, 0xDD,
            0x7E, 0x80, 0xDD, 0x70, 0x80, 0xDD, 0x7E, 0x80,
            0xDD, 0x71, 0x80, 0xDD, 0x7E, 0x80, 0xDD, 0x72,
            0x80, 0xDD, 0x7E, 0x80, 0xDD, 0x73, 0x80, 0xDD,
            0x7E, 0x80, 0xDD, 0x74, 0x80, 0xDD, 0x7E, 0x80,
            0xDD, 0x75, 0x80, 0xDD, 0x7E, 0x80
    };
...
TEST_F(LoadTest, LD_indexed_iy_register_test){
    ...
    constexpr std::array<uint8_t, 62> memory = {
            0xFD, 0x21, 0x00, 0x01, 0x3E, 0x01, 0x06, 0x02,
            0x0E, 0x03, 0x16, 0x04, 0x1E, 0x05, 0x26, 0x06,
            0x2E, 0x07, 0xFD, 0x77, 0x80, 0x3E, 0x00, 0xFD,
            0x7E, 0x80, 0xFD, 0x70, 0x80, 0xFD, 0x7E, 0x80,
            0xFD, 0x71, 0x80, 0xFD, 0x7E, 0x80, 0xFD, 0x72,
            0x80, 0xFD, 0x7E, 0x80, 0xFD, 0x73, 0x80, 0xFD,
            0x7E, 0x80, 0xFD, 0x74, 0x80, 0xFD, 0x7E, 0x80,
            0xFD, 0x75, 0x80, 0xFD, 0x7E, 0x80
    };
...
// 16 Bit Tests
TEST_F(LoadTest, LD_register_immediate_extended_ix_test){
