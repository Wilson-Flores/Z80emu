...
void z80cpu::BIT_implied() {
    ...
    temp_result_8_ = (register_value >> temp_data_8_) & BIT_MASK_5;


    // S is set if b = 7 and tested bit is set
    set_flag(SIGN_FLAG, ((temp_data_8_ == 7) && temp_result_8_ == 1));
    ...
    set_flag(PARITY_OVERFLOW_FLAG, temp_result_8_ == 0);
    // N is always reset
...
void z80cpu::BIT_indexed_ix() {
    ...
    set_flag(X_FLAG, temp_memory_address_ & X_FLAG_MASK_2);
    set_flag(Y_FLAG, temp_memory_address_ & Y_FLAG_MASK_2);
}
