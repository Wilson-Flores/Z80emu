...
void z80cpu::POP_register_indirect_register() {
    ...
    *register_pair_table[register_pair_bit].low_byte_register = ram_read(stack_pointer);
    ...
    *register_pair_table[register_pair_bit].high_byte_register = ram_read(stack_pointer);
