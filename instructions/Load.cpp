...
void z80cpu::LD_register_immediate_extended_16_bit() {
    ...
    *register_pair_table_ss_[temp_data_8_].high_byte_register = high_byte;
    *register_pair_table_ss_[temp_data_8_].low_byte_register = low_byte;
}
...
void z80cpu::LD_register_immediate_extended_ix() {
    ...
    temp_data_16_ = (static_cast<uint16_t>(high_byte) << 8) | low_byte;
...
void z80cpu::LDI_register_indirect_register_indirect() {
    ...
    set_flag(Y_FLAG, temp_data_8_ & Y_FLAG_MASK_3);
}
